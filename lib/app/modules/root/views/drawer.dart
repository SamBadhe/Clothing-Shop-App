          ...
          return Row(
            children: [
              ...
              SizedBox(
                ...
                child: Drawer(
                  backgroundColor: settingsController.selectedPersona.value?.backgroundColor ?? Colors.white,
  ...
  List<Widget> drawerItems(BuildContext context, Rx<Iterable<Screen>> values) {
    ...
    List<Widget> list = [
      Container(
        ...
        color: settingsController.selectedPersona.value?.backgroundColor ?? Colors.blueGrey,
        child: Align(
